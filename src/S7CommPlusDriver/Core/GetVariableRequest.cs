...
{
    internal class GetVariableRequest : IS7pRequest
    {
        ...
        public GetVariableRequest(byte protocolVersion)
        {
        ...
        public int Serialize(Stream buffer)
        {
            ...
            ret += S7p.EncodeUInt32Vlq(buffer, 1);
        ...
        {
            string s = "";
            s += "<GetVariableRequest>" + Environment.NewLine;
